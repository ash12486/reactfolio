    ...
    <section className="container mx-auto px-4 pt-24 pb-12 md:pt-32 md:pb-20 h-screen">
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="mt-6 md:mt-0">
          ...
          <h1 className="text-3xl md:text-6xl lg:text-6xl font-bold text-gray-800">
            Ashlee Huff
          </h1>
          <h2 className="text-2xl md:text-3xl lg:text-3xl font-bold text-gray-500">
            I'm a Full Stack Developer.
          </h2>
          <p className="text-gray-500 py-4 md:text-lg lg:text=2xl max-w-[500px]">
            I am a passionate web developer with experience in various web
            technologies such as HTML, CSS, JavaScript, React, and Node.js. I
            enjoy building responsive and intuitive web applications, and I am
            always eager to learn new technologies and expand my skill set.
          </p>
          <div>
            <Link to="/portfolio">
              <button className="bg-yellow-500 text-white font-semibold border-2 px-6 py-3 my-2 flex justify-center items-center hover:bg-yellow-600 hover:border-yellow-600">
                View Portfolio
              </button>
            </Link>
          </div>
